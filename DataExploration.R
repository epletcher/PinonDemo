...
# plot size t and size t-1 (all size variables, years combined)
par(mfrow=c(2,3))
...
## Growth - size at as a function of size tmin1, by year
plot_grid(
...
## survival - survival as a function of size, by year
plot_grid(
  demo.data %>% 
    # filter to at least remove 2012 and 2021 for a lack of previous year data, but other years may have too little data to be useful too
    filter(Year != 2012 & Year != 2021) %>%
